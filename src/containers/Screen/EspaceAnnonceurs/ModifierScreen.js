      ...
      return (
        <MainLayout page_single title="Modifier" navigation={this.props.navigation}>
          <View style={styleEspaceAnnonceur.content}>
            <HeaderEspaceAnnonceur title='Modifier' />  
                        ...
                        <Field
                          ...
                          <View style={{display: 'none'}}>
                            <Field
                              name={'event'}
                              component={inputText}
                              defaultValue={annonce.event.toString()}
                            />  
                          </View>
                ...
                <View style={styleForm.contentForm}>
                  ...
                  {/*<View>
                    ...
                    <Picker
                      ...
                      style={{ height: 40, color: '#465a7e' }}
                      textStyle={{ fontFamily: 'Montserrat-Regular' }}
                      onValueChange={(itemValue, itemIndex) => this.setState({recurrence: itemValue})}>
                      <Picker.Item label="Pas de récurrence" value="Pas de récurrence" />
                      <Picker.Item label="Toutes les semaines" value="Catégorie 1" />
                      <Picker.Item label="Tous les mois" value="Catégorie 1" />
                      <Picker.Item label="Tous les ans" value="Catégorie 2" />
                    </Picker>
                  </View>*/}
